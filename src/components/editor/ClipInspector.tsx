...
import { Sliders, Palette, Eye, Volume2, Gauge, Move, RotateCcw, Eraser, Crosshair } from 'lucide-react';
...
export default function ClipInspector({ width }: { width: number }) {
  ...
  const [activeTab, setActiveTab] = useState<'video' | 'audio' | 'speed' | 'adjust'>('video');
